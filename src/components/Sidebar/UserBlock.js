					...
					>
						...
						>
							...
							<div className="user-info">
								<span className="user-name ml-4">{userInfo.firstName + " " + userInfo.lastName}</span>
						...
						<DropdownMenu>
							<ul className="list-unstyled mb-0">
								<li className="p-15 border-bottom user-profile-top bg-primary rounded-top">
									<p className="text-white mb-0 fs-14">{userInfo.firstName + " " + userInfo.lastName}</p>
									<span className="text-white fs-14">{userInfo.email}</span>
								</li>
								<li>
									<Link to={{
